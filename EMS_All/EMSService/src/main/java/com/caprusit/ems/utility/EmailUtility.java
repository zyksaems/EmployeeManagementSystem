...
public class EmailUtility {
   ...
   *          subject of mail
   */
  public void sendMail(String recipientMailId, String message, String recipientName,
      String subject) {
   ...
   * 
   * @param ccStatus
   *          if it is true we are including cc else we are not putting any cc
   */
  private void sendEmailUsingJavaMail(boolean ccStatus) {
    ...
    try {
      ...
      mimeMessage
          .setText("Dear " + recipientName + "," + message + " \n\nRegards,\nCaprusIT Team.");
