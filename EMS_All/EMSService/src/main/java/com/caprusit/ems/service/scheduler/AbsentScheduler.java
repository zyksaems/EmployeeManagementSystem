...
public class AbsentScheduler {
  ...
  public void updateAbsentEmployees() {
    ...
    List<Object> absentDetailsList = SchedulerDaoObjectsUtility.attendanceDao
        .getAbsentEmployeeDetails();
    ...
    for (Object empdetails : absentDetailsList) {
      ...
      logger.info("employee id : " + employeeDetails[0] + " employee name: " + employeeDetails[1]
          + " " + employeeDetails[2] + "  email: " + employeeDetails[3]);
      ...
      try {
        SchedulerDaoObjectsUtility.emailUtility.sendMail((String) employeeDetails[3], absentmessage,
            employeeDetails[1] + " " + employeeDetails[2], "EMS Absent alert");
      } catch (Exception e) {
