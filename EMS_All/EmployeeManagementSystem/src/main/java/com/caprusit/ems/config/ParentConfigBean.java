...
public class ParentConfigBean {
  ...
  public LocalSessionFactoryBean getSessionFactory() throws Exception {
    ...
    hibernateProperties
        .load(new ClassPathResource("properties/hibernate.properties").getInputStream()); 
   ...
   *  @return {@link UploadExcelFileUtility}
   */
  @Bean
  ...
  /**
   * Returns HibernateTransactionManager.(to apply transaction management for hibernate)
