...
public class ManageUserDAOImpl implements IManageUserDAO {
  ...
  /**
   * This method reads all employee details Returns as List of Employee
   */
  public List<Employee> getEmployees() {
    logger.info("inside ManageUserDAOImpl getEmployees()");

    Criteria allEmployeeCriteria = HibernateSessionUtility.getHibernateSession()
  ...
  public List<EmployeeForDate> getAllEmployeesData() {
    ...
    while (it.hasNext()) {
      ...
      /*
       * Object rows[] = (Object[])it.next(); logger.info(rows[0]+ "||"
   ...
   * 
   * @param encEmp
   *          EncryptedEmployee object to save into database
