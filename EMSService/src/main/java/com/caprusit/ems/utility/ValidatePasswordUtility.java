...
public class ValidatePasswordUtility {
  ...
  /**
   * This method takes plain password and encrypted password if plain password is correct returns
   * true otherwise returns false
   */
  public static boolean validatePassword(String plainPassword, byte[] encryptedPassword) {
    logger.info(
        "inside ValidatePasswordUtility class -- validatePassword(String plainPassword,byte [] encryptedPassword)");
