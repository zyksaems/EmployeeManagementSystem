...
public class EmsConditions {
	...
	// Employee not logout from office remind employee (every few minutes) time
	// in minutes
	...
	// employee leave approved message
	public static final String EMPLOYEE_LEAVE_APPROVED = "Approved";

	// employee leave disapproved message
	public static final String EMPLOYEE_LEAVE_DIS_APPROVED = "Disapproved";

	// employee leave pending  message
	public static final String EMPLOYEE_LEAVE_PENDING = "Pending";
