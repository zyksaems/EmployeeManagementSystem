...
public class ParentConfigBean {
  ...
  public LocalSessionFactoryBean getSessionFactory() throws Exception {
    ...
    p.load(new ClassPathResource("properties/hibernate.properties").getInputStream()); // load gives
                                                                                       // FileNotFound
                                                                                       // and
                                                                                       // IOException
  ...
  /**
   * Bean for PropertyPlaceHolderConfigurer(for reading properties file and setting values to
   * variables)
   */
  @Bean
   ...
   * @return {@link MethodInvokingJobDetailFactoryBean}
   */
  ...
  @Bean
  @Autowired
  public SchedulerDaoObjectsUtility getSchedulerDaoObjectsUtility(IAttendanceDAO attendance,
      IManageUserDAO manageUser, EmailUtility emaily) {
