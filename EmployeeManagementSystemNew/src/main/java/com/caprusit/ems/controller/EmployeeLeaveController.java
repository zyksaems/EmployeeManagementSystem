...
public class EmployeeLeaveController {
  ...
  public String viewEmployeeLeavePage(HttpServletRequest request) {
    ...
    return (HttpSessionUtility.verifySession(request, "employeeId")) ? "ShowEmployeeLeaves"
        : "EmsHomePage";
  ...
  public String viewEmployeeLeaveStatusPage(HttpServletRequest request) {
    ...
    return (HttpSessionUtility.verifySession(request, "employeeId")) ? "EmployeeViewLeaveStatus"
        : "EmsHomePage";
  ...
  public String viewPendingLeavesPage(HttpServletRequest request) {
    ...
    return (HttpSessionUtility.verifySession(request, "adminId")) ? "AdminViewPendingLeaves"
        : "EmsHomePage";
  ...
  public String viewDisApprovedLeavesPage(HttpServletRequest request) {
    ...
    return (HttpSessionUtility.verifySession(request, "adminId")) ? "AdminViewDisapprovedLeaves"
        : "EmsHomePage";
  ...
  public String viewApprovedLeavesPage(HttpServletRequest request) {
    ...
    return (HttpSessionUtility.verifySession(request, "adminId")) ? "AdminViewApprovedLeaves"
        : "EmsHomePage";
   ...
   * 
   * @param request
   *          servlet request to verify session
   * @param appliedMonth
   *          month in which applied for leave EX: 2016-04
   * @param empId
   *          employee id
   * @return JSON object array of leave details
   */
  @RequestMapping(value = "/verifyEmployeeLeaveStatus", method = RequestMethod.POST)
  public @ResponseBody String verifyEmployeeLeaveStatus(HttpServletRequest request,
      @RequestParam("leaveAppliedMonth") String appliedMonth,
  ...
  public @ResponseBody String getEmployeeMonthLeaveDates(HttpServletRequest request,
   ...
   * 
   * @param request
   *          HttpServletRequest object to verify session
   * @return apply leave page if session exists home page if session expires
   */
  @RequestMapping(value = "/applyForLeave", method = RequestMethod.GET)
  public String applyForLeave(HttpServletRequest request) {

    return (HttpSessionUtility.verifySession(request, "employeeId")) ? "ApplyLeaveForEmployee"
        : "EmsHomePage";
  }
   ...
   *          HttpServletRequest object to verify session
   * @param employeeLeave
   *          EmployeeLeave class object
   * @param leaveDates
   *          string of leave dates to apply for leave
   * @return 1 on successfully applied. 0 if unsuccessful -1 if session expires
   */
  @RequestMapping(value = "/employeeApplyForLeave", method = RequestMethod.POST)
  public @ResponseBody int applyLeave(HttpServletRequest request,
      @ModelAttribute EmployeeLeave employeeLeave, @RequestParam("leaveDates") String leaveDates) {
    if (HttpSessionUtility.verifySession(request, "employeeId")) {
  ...
  public @ResponseBody String getEmployeeLeaveNotification(
  ...
  public String getEmployeeLeaveDetailsView(HttpServletRequest request) {
    ...
    return (HttpSessionUtility.verifySession(request, "adminId")) ? "AdminViewAllLeaves"
        : "EmsHomePage";
   ...
   * @param status
   *          status 1 for approving, 0 for disapproving
  ...
  public @ResponseBody int updateLeaveStatus(HttpServletRequest request,
      @RequestParam("leaveId") int leaveId, @RequestParam("status") int status) {
  ...
  public @ResponseBody String getApprovedLeavesByMonth(HttpServletRequest request,
      @RequestParam("month") String month) {
  ...
  public @ResponseBody String getAllLeavesByGivenMonth(HttpServletRequest request,
      @RequestParam("month") String month) {
    logger.info("month received: " + month);
    if (HttpSessionUtility.verifySession(request, "adminId")) {
